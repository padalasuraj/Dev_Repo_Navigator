...
function fetchUserRepos(username, page) {
    fetch(`https://api.github.com/users/${username}/repos?per_page=10&page=${page}`, { mode: 'cors' })
        .then((response) => {
            if (!response.ok) {
    ...
    profileContainer.innerHTML = `
        <div id="profile">
            ...
            <div id="user-details">
                ...
                <p> <i class="material-icons" style="font-size:26px">location_on</i> Location: ${user.location || "N/A"}</p>
